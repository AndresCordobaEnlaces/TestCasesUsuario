 ...
 * UsuarioTest con dos conjuntos de pruebas para el método validarRegistro():
 * <ul>
 ...
 * </ul>
 * Se deberá crear un excel con las clases de equivalencia y los test cases aplicando la estrategia
 * de pruebas pairwise en ambos casos. Se debe entregar la url del proyecto en Github.
 */
public class Usuario {
    ...
    public boolean validarRegistro() {
        return validarUsuario() && validarContrasena() && validarCorreo() && validarEdad();
    }
}
